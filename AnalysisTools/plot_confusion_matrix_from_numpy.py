...
def plot_confusion_matrix(cm, classes,
    ...
    """
    if normalize:
        # normalise the confusion matrix so that
...
cnf_matrix = np.load('weights/Distillation_MIX_ValBalanceResam_bs8_SimpleNet/LCZ42_SGD_5_7213.npy')
cnf_tr = np.trace(cnf_matrix)
cnf_tr = cnf_tr.astype('float')
print(cnf_tr/np.sum(cnf_matrix))
